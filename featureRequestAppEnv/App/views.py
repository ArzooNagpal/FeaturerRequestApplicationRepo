...
# On flask app run whenever the browser requests for the URL 'http://127.0.0.1:5000/featureRequestForm, the function defined renders form.html
@app.route('/featureRequestForm')
def featureRequestForm():
    return render_template('featureRequestForm.html')
# On flask app run whenever the browser requests for the URL 'http://127.0.0.1:5000/featureRequestDetails, the function defined renders table.html
